...
const token = process.env.TG_BOT_TOKEN || 'REPLACE_WITH_YOUR_BOT_TOKEN';
if (token === 'REPLACE_WITH_YOUR_BOT_TOKEN') console.warn('Set TG_BOT_TOKEN env var or replace token in file before running.');
const bot = new TelegramBot(token, { polling: true });

bot.onText(/\/start/, (msg) => {
  const chatId = msg.chat.id;
  const webAppUrl = 'https://<your-username>.github.io/<repo>/'; // <- replace with your GitHub Pages URL
